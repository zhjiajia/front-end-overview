export default class Util_setCSS {
    public static setCSS(css: string): void {
        ...
        var styleSheet: HTMLStyleElement = Array.from(document.querySelectorAll('style')).find(item => item.id === 'defined') as HTMLStyleElement;
